...
export default function Accessories() {
    ...
    return (
        ...
        <div>
            <h1 className="text-center text-4xl font-extrabold m-10">Accessories</h1>
            <p className="text-center text-2xl mb-10">
                Modular and specialized, these technical enhancements optimize weapon handling and provide a distinct tactical advantage.
            </p>
            <motion.div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-16">
                    {products.filter((item) => item.type==='access').map((item) => {
